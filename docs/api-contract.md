...
| GET | `/api/library/facets` | `LibraryFacets` — genres, moods, themes, eras and composers that exist, with counts | implemented |
...
| POST | `/api/volume` | `PlaybackState` | implemented |
