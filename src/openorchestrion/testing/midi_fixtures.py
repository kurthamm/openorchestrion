...
#: Rights for the generated suite. This is the one body of content the project
#: can clear from first principles: it is the output of a generator in this
#: repository rather than anyone else's music, so the only terms that apply are
#: the project's own.
SUITE_RIGHTS = RightsEvidence(
